...
import LogoStyle from '../assets/css/Logo.module.css';
...
export default function Logo() {
    ...
    return (
        <div className={LogoStyle.logo}>
            ...
            <div className={LogoStyle.glasses}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103.63 42.68">
                    <g>
                        <g>
                            <rect
                                className={`${LogoStyle.coloredLine} border`}
                                x="30.08"
                                y="11.04"
                                width="2.54"
                                height="15.01"
                            ...
                            />
                            <path
                                className={[LogoStyle.coloredLine, 'border'].join(' ')}
